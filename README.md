...
bOptimizer aims to eliminate this bottleneck by linking all project sources and their dependencies into a single bundled file, which drastically reduces the amount of work to be done during cold starts, and hence increases startup performance noticeably.

## Building from source

The prerequesites for cross-compilation to all supported targets are:
